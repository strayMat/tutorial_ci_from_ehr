...
%DIF ADD causal_decision_making.tex   Wed Feb  7 10:14:09 2024
...
\cite{von2007strengthening,benchimol2015reporting,hernan2020causal,schneeweiss2021conducting,zeng2022uncovering}}\hspace{0pt}%DIFAUXCMD
,
there, emphasis primarily lies on biases stemming from confounding variables, with
...
\DIFadd{In contrast, machine }\DIFaddend learning and causal inference literature \DIFdelbegin \DIFdel{focuses on estimators
\mbox{%DIFAUXCMD
...
\cite{suissa2008immortal,fu2021timing}. \DIFdelbegin \DIFdel{Here, putting all steps --choice }\DIFdelend \DIFaddbegin \DIFadd{Recently, the machine learning community
