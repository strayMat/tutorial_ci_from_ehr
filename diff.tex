...
%DIF ADD causal_decision_making.tex   Fri Feb  2 17:22:22 2024
...
\DIFdelbegin \DIFdel{Machine }\DIFdelend \DIFaddbegin \DIFadd{Relating variables to known causal types \mbox{%DIFAUXCMD
    \cite{greenland1999causal,vanderweele2007four} }\hspace{0pt}%DIFAUXCMD
  is sometimes
  a speculative exercise for medical practitioners facing the complexity of an
  EHR.
}
...
\cite{suissa2008immortal,fu2021timing}.
\DIFdelbegin \DIFdel{Here, putting all steps --choice }\DIFdelend \DIFaddbegin
