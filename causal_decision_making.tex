...
Fig \ref{apd:selection_flowchart} makes inclusion and exclusion choices for PICOT explicit.
...
\ref{apd:immortal_time_bias}) occurs when the follow-up period,
...
(\nameref{apd:vibration_analysis_for_confounders}). Fig
...
Fig \ref{apd:fig:immortal_time_bias} illustrates the immortal time bias.
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.7\linewidth]{img_supp_final/catalog_of_bias_immortal_time_bias.png}
  \caption{{\bf Immortal time bias illustration.}\\Poor experimental design can introduce Immortal time bias, which
...
Drawing a graphical timeline as the one in Fig
\ref{fig:cohort_timeline_albumin} during the study design helps to detect and
prevent time-related biases.

\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{img_supp_final/timeline_albumin_for_sepsis.pdf}
  \caption{{\bf Graphical timeline.}\\ Defining the inclusion event, the starting time T0 for follow-up, the
...
\begin{figure}[h!]
  \centering%
  \includegraphics[width=\linewidth]{img_supp_final/dagitty_graph.pdf}
...
Compared to Fig \ref{fig:vibration_analysis}, we also report in
Fig \ref{apd:fig:detailed_results} the estimates for Causal forest
estimators and other choices of feature aggregation (first and last).
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{img_supp_final/main_vibration_analysis_supp.pdf}
  \caption{{\bf Full sensitivity analysis.}\\The estimators with forest nuisances
...
Compared to Fig \ref{fig:vibration:itb}, we also report in Fig
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{img_supp_final/itb__dr_forest_agg_first_last__bs_30_supp.pdf}
  \caption{{\bf Sensitivity analysis for immortal time bias.}\\Every choice of
...
Fig \ref{fig:vibration:confounders} shows that small
