...
\nameref{apd:statistical_considerations} details general sanity checks for
...
implementations. \nameref{apd:statistical_considerations} details statistical considerations that we identified as important but missing in these packages, namely lack of cross fitting estimators, bad practices for imputation, or lack of closed form confidence intervals.
